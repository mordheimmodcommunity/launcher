...
function getPath() {
  ...
  if (process.platform === 'darwin') {
    return path.join(process.cwd(), '7zip', 'mac', '7za')
  } else if (process.platform === 'win32') {
    return path.join(process.cwd(), '7zip', 'win', process.arch, '7za.exe')
  } else {
    return path.join(process.cwd(), '7zip', 'linux', process.arch, '7za')
  }
}

const path7za = getPath()
